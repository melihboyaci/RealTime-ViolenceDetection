...
- **Deployment decision threshold** — initial **0.7** retuned to **0.4** via val-split F1 maximization (val F1=0.773). Test-split result at t=0.4: P=0.744, R=0.931, F1=0.827, AUC-ROC=0.921.
